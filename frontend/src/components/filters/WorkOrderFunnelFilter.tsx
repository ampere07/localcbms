...
const allColumns: Column[] = [
  ...
  { key: 'instructions', label: 'Instructions', table: 'work_orders', dataType: 'text' },
  { key: 'report_to', label: 'Report To', table: 'work_orders', dataType: 'varchar' },
  { key: 'assign_to', label: 'Assign To', table: 'work_orders', dataType: 'varchar' },
  { key: 'remarks', label: 'Remarks', table: 'work_orders', dataType: 'text' },
  { key: 'work_status', label: 'Work Status', table: 'work_orders', dataType: 'varchar' },
  { key: 'work_category', label: 'Work Category', table: 'work_orders', dataType: 'varchar' },
  { key: 'requested_by', label: 'Requested By', table: 'work_orders', dataType: 'varchar' },
  { key: 'requested_date', label: 'Requested Date', table: 'work_orders', dataType: 'datetime' },
  { key: 'updated_by', label: 'Updated By', table: 'work_orders', dataType: 'varchar' },
  { key: 'updated_date', label: 'Updated Date', table: 'work_orders', dataType: 'datetime' },
];
