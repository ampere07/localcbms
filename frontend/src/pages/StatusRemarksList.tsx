    ...
    return (
      <div className={`h-full flex items-center justify-center ${isDarkMode ? 'bg-gray-950' : 'bg-gray-50'
        ...
        <div className="text-center">
          <Loader2 className="animate-spin h-12 w-12 mb-4 mx-auto" style={{ color: colorPalette?.primary || '#7c3aed' }} />
        ...
        {filteredRemarks.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className={`border-b sticky top-0 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-100 border-gray-200'
                }`}>
                <tr>
                  <th className={`px-6 py-4 text-left font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'
                    }`}>Status Remarks</th>
                  <th className={`px-6 py-4 text-left font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'
              ...
              <tbody>
                {filteredRemarks.map((remark) => (
                  <tr key={remark.id} className={`border-b transition-colors ${isDarkMode ? 'bg-gray-900 border-gray-800 hover:bg-gray-800' : 'bg-white border-gray-200 hover:bg-gray-50'
                    }`}>
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-md">
              <div className={`px-6 py-4 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-600'
                }`}>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-3 pt-4">
                  <button
                    type="button"
                    onClick={() => setShowAddModal(false)}
                    className={`flex-1 px-4 py-2 border rounded transition-colors ${isDarkMode
